...
board = pd.read_csv("../Boards (Historical and Present)/2025_board.csv")
...
QB_grades.to_csv("2025 Draft Eligible Player's Grades/QB_grades.csv", index=False)
RB_grades.to_csv("2025 Draft Eligible Player's Grades/RB_grades.csv", index=False)
REC_grades.to_csv("2025 Draft Eligible Player's Grades/REC_grades.csv", index=False)
OL_grades.to_csv("2025 Draft Eligible Player's Grades/OL_grades.csv", index=False)
DL_grades.to_csv("2025 Draft Eligible Player's Grades/DL_grades.csv", index=False)
ED_grades.to_csv("2025 Draft Eligible Player's Grades/ED_grades.csv", index=False)
LB_grades.to_csv("2025 Draft Eligible Player's Grades/LB_grades.csv", index=False)
CB_grades.to_csv("2025 Draft Eligible Player's Grades/CB_grades.csv", index=False)
S_grades.to_csv("2025 Draft Eligible Player's Grades/S_grades.csv", index=False)